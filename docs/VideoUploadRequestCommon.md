...
video_upload_request_common_instance = VideoUploadRequestCommon.from_json(json)
# print the JSON string representation of the object
print VideoUploadRequestCommon.to_json()

# convert the object into a dict
video_upload_request_common_dict = video_upload_request_common_instance.to_dict()
# create an instance of VideoUploadRequestCommon from a dict
video_upload_request_common_form_dict = video_upload_request_common.from_dict(video_upload_request_common_dict)
```
