...
from pydantic import Field, StrictBytes, StrictFloat, StrictInt, StrictStr, conint
...
class MyUserApi(object):
    ...
    @validate_arguments
    def api_v1_users_me_avatar_delete(self, **kwargs) -> None:  # noqa: E501
        """Delete my avatar  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_avatar_delete(async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_v1_users_me_avatar_delete_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_v1_users_me_avatar_delete_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def api_v1_users_me_avatar_delete_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete my avatar  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_avatar_delete_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_v1_users_me_avatar_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_v1_users_me_avatar_pick_post(self, avatarfile : Annotated[Optional[Union[StrictBytes, StrictStr]], Field(description="The file to upload")] = None, **kwargs) -> ApiV1UsersMeAvatarPickPost200Response:  # noqa: E501
        """Update my user avatar  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_avatar_pick_post(avatarfile, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_v1_users_me_avatar_pick_post_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_v1_users_me_avatar_pick_post_with_http_info(avatarfile, **kwargs)  # noqa: E501

    @validate_arguments
    def api_v1_users_me_avatar_pick_post_with_http_info(self, avatarfile : Annotated[Optional[Union[StrictBytes, StrictStr]], Field(description="The file to upload")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update my user avatar  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_avatar_pick_post_with_http_info(avatarfile, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v1_users_me_avatar_pick_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_v1_users_me_video_quota_used_get(self, **kwargs) -> ApiV1UsersMeVideoQuotaUsedGet200Response:  # noqa: E501
        """Get my user used quota  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_video_quota_used_get(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ApiV1UsersMeVideoQuotaUsedGet200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_v1_users_me_video_quota_used_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_v1_users_me_video_quota_used_get_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def api_v1_users_me_video_quota_used_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get my user used quota  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_video_quota_used_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ApiV1UsersMeVideoQuotaUsedGet200Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v1_users_me_video_quota_used_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ApiV1UsersMeVideoQuotaUsedGet200Response",
        }
    ...
    @validate_arguments
    def get_user_info(self, **kwargs) -> List[User]:  # noqa: E501
    ...
    @validate_arguments
    def put_user_info(self, update_me : UpdateMe, **kwargs) -> None:  # noqa: E501
        """Update my user information  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_user_info(update_me, async_req=True)
        >>> result = thread.get()

        :param update_me: (required)
        :type update_me: UpdateMe
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the put_user_info_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.put_user_info_with_http_info(update_me, **kwargs)  # noqa: E501

    @validate_arguments
    def put_user_info_with_http_info(self, update_me : UpdateMe, **kwargs) -> ApiResponse:  # noqa: E501
        """Update my user information  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.put_user_info_with_http_info(update_me, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['update_me'] is not None:
            _body_params = _params['update_me']
