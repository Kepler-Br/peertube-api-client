...
class ChannelsSyncApi(object):
    ...
    @validate_arguments
    def add_video_channel_sync(self, video_channel_sync_create : Optional[VideoChannelSyncCreate] = None, **kwargs) -> AddVideoChannelSync200Response:  # noqa: E501
        """Create a synchronization for a video channel  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.add_video_channel_sync(video_channel_sync_create, async_req=True)
        >>> result = thread.get()

        :param video_channel_sync_create:
        :type video_channel_sync_create: VideoChannelSyncCreate
        ...
        :rtype: AddVideoChannelSync200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the add_video_channel_sync_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.add_video_channel_sync_with_http_info(video_channel_sync_create, **kwargs)  # noqa: E501

    @validate_arguments
    def add_video_channel_sync_with_http_info(self, video_channel_sync_create : Optional[VideoChannelSyncCreate] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a synchronization for a video channel  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.add_video_channel_sync_with_http_info(video_channel_sync_create, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AddVideoChannelSync200Response, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'video_channel_sync_create'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method add_video_channel_sync" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['video_channel_sync_create'] is not None:
            _body_params = _params['video_channel_sync_create']
        ...
        _response_types_map = {
            '200': "AddVideoChannelSync200Response",
        }
    ...
    @validate_arguments
    def del_video_channel_sync(self, channel_sync_id : Annotated[conint(strict=True, ge=1), Field(..., description="Channel Sync id")], **kwargs) -> None:  # noqa: E501
        """Delete a video channel synchronization  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.del_video_channel_sync(channel_sync_id, async_req=True)
        >>> result = thread.get()

        :param channel_sync_id: Channel Sync id (required)
        :type channel_sync_id: int
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the del_video_channel_sync_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.del_video_channel_sync_with_http_info(channel_sync_id, **kwargs)  # noqa: E501

    @validate_arguments
    def del_video_channel_sync_with_http_info(self, channel_sync_id : Annotated[conint(strict=True, ge=1), Field(..., description="Channel Sync id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a video channel synchronization  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.del_video_channel_sync_with_http_info(channel_sync_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method del_video_channel_sync" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the path parameters
        _path_params = {}
        if _params['channel_sync_id']:
            _path_params['channelSyncId'] = _params['channel_sync_id']
    ...
    @validate_arguments
    def trigger_video_channel_sync(self, channel_sync_id : Annotated[conint(strict=True, ge=1), Field(..., description="Channel Sync id")], **kwargs) -> None:  # noqa: E501
        """Triggers the channel synchronization job, fetching all the videos from the remote channel  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.trigger_video_channel_sync(channel_sync_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the trigger_video_channel_sync_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.trigger_video_channel_sync_with_http_info(channel_sync_id, **kwargs)  # noqa: E501

    @validate_arguments
    def trigger_video_channel_sync_with_http_info(self, channel_sync_id : Annotated[conint(strict=True, ge=1), Field(..., description="Channel Sync id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Triggers the channel synchronization job, fetching all the videos from the remote channel  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.trigger_video_channel_sync_with_http_info(channel_sync_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method trigger_video_channel_sync" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
