...
class MySubscriptionsApi(object):
    ...
    @validate_arguments
    def api_v1_users_me_subscriptions_exist_get(self, uris : Annotated[conlist(StrictStr), Field(..., description="list of uris to check if each is part of the user subscriptions")], **kwargs) -> object:  # noqa: E501
        """Get if subscriptions exist for my user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_subscriptions_exist_get(uris, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_v1_users_me_subscriptions_exist_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_v1_users_me_subscriptions_exist_get_with_http_info(uris, **kwargs)  # noqa: E501

    @validate_arguments
    def api_v1_users_me_subscriptions_exist_get_with_http_info(self, uris : Annotated[conlist(StrictStr), Field(..., description="list of uris to check if each is part of the user subscriptions")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get if subscriptions exist for my user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_subscriptions_exist_get_with_http_info(uris, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_v1_users_me_subscriptions_exist_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('uris') is not None:  # noqa: E501
            ...
            _collection_formats['uris'] = 'multi'
    ...
    @validate_arguments
    def api_v1_users_me_subscriptions_get(self, start : Annotated[Optional[conint(strict=True, ge=0)], Field(description="Offset used to paginate results")] = None, count : Annotated[Optional[conint(strict=True, le=100, ge=1)], Field(description="Number of items to return")] = None, sort : Annotated[Optional[StrictStr], Field(description="Sort column")] = None, **kwargs) -> VideoChannelList:  # noqa: E501
        """Get my user subscriptions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_subscriptions_get(start, count, sort, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_v1_users_me_subscriptions_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_v1_users_me_subscriptions_get_with_http_info(start, count, sort, **kwargs)  # noqa: E501

    @validate_arguments
    def api_v1_users_me_subscriptions_get_with_http_info(self, start : Annotated[Optional[conint(strict=True, ge=0)], Field(description="Offset used to paginate results")] = None, count : Annotated[Optional[conint(strict=True, le=100, ge=1)], Field(description="Number of items to return")] = None, sort : Annotated[Optional[StrictStr], Field(description="Sort column")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get my user subscriptions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_subscriptions_get_with_http_info(start, count, sort, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v1_users_me_subscriptions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_v1_users_me_subscriptions_post(self, api_v1_users_me_subscriptions_post_request : Optional[ApiV1UsersMeSubscriptionsPostRequest] = None, **kwargs) -> None:  # noqa: E501
        """Add subscription to my user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_subscriptions_post(api_v1_users_me_subscriptions_post_request, async_req=True)
        >>> result = thread.get()

        :param api_v1_users_me_subscriptions_post_request:
        :type api_v1_users_me_subscriptions_post_request: ApiV1UsersMeSubscriptionsPostRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_v1_users_me_subscriptions_post_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_v1_users_me_subscriptions_post_with_http_info(api_v1_users_me_subscriptions_post_request, **kwargs)  # noqa: E501

    @validate_arguments
    def api_v1_users_me_subscriptions_post_with_http_info(self, api_v1_users_me_subscriptions_post_request : Optional[ApiV1UsersMeSubscriptionsPostRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Add subscription to my user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_subscriptions_post_with_http_info(api_v1_users_me_subscriptions_post_request, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            'api_v1_users_me_subscriptions_post_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v1_users_me_subscriptions_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['api_v1_users_me_subscriptions_post_request'] is not None:
            _body_params = _params['api_v1_users_me_subscriptions_post_request']
    ...
    @validate_arguments
    def api_v1_users_me_subscriptions_subscription_handle_delete(self, subscription_handle : Annotated[StrictStr, Field(..., description="The subscription handle")], **kwargs) -> None:  # noqa: E501
        """Delete subscription of my user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_subscriptions_subscription_handle_delete(subscription_handle, async_req=True)
        >>> result = thread.get()

        :param subscription_handle: The subscription handle (required)
        :type subscription_handle: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_v1_users_me_subscriptions_subscription_handle_delete_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_v1_users_me_subscriptions_subscription_handle_delete_with_http_info(subscription_handle, **kwargs)  # noqa: E501

    @validate_arguments
    def api_v1_users_me_subscriptions_subscription_handle_delete_with_http_info(self, subscription_handle : Annotated[StrictStr, Field(..., description="The subscription handle")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete subscription of my user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_subscriptions_subscription_handle_delete_with_http_info(subscription_handle, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v1_users_me_subscriptions_subscription_handle_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the path parameters
        _path_params = {}
        if _params['subscription_handle']:
            _path_params['subscriptionHandle'] = _params['subscription_handle']
    ...
    @validate_arguments
    def api_v1_users_me_subscriptions_subscription_handle_get(self, subscription_handle : Annotated[StrictStr, Field(..., description="The subscription handle")], **kwargs) -> VideoChannel:  # noqa: E501
        """Get subscription of my user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_subscriptions_subscription_handle_get(subscription_handle, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_v1_users_me_subscriptions_subscription_handle_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_v1_users_me_subscriptions_subscription_handle_get_with_http_info(subscription_handle, **kwargs)  # noqa: E501

    @validate_arguments
    def api_v1_users_me_subscriptions_subscription_handle_get_with_http_info(self, subscription_handle : Annotated[StrictStr, Field(..., description="The subscription handle")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get subscription of my user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_v1_users_me_subscriptions_subscription_handle_get_with_http_info(subscription_handle, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v1_users_me_subscriptions_subscription_handle_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
