...
class VideoTranscodingApi(object):
    ...
    @validate_arguments
    def create_video_transcoding(self, id : Annotated[Any, Field(..., description="The object id, uuid or short uuid")], create_video_transcoding_request : Optional[CreateVideoTranscodingRequest] = None, **kwargs) -> None:  # noqa: E501
        """Create a transcoding job  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_video_transcoding(id, create_video_transcoding_request, async_req=True)
        >>> result = thread.get()

        :param id: The object id, uuid or short uuid (required)
        :type id: ApiV1VideosOwnershipIdAcceptPostIdParameter
        :param create_video_transcoding_request:
        :type create_video_transcoding_request: CreateVideoTranscodingRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the create_video_transcoding_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.create_video_transcoding_with_http_info(id, create_video_transcoding_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_video_transcoding_with_http_info(self, id : Annotated[Any, Field(..., description="The object id, uuid or short uuid")], create_video_transcoding_request : Optional[CreateVideoTranscodingRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a transcoding job  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_video_transcoding_with_http_info(id, create_video_transcoding_request, async_req=True)
        >>> result = thread.get()
        ...
        _all_params = [
            'id',
            'create_video_transcoding_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_video_transcoding" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['create_video_transcoding_request'] is not None:
            _body_params = _params['create_video_transcoding_request']
