...
class VideoConstantStringLanguage(BaseModel):
    """
    VideoConstantStringLanguage
    """
    id: Optional[StrictStr] = Field(None, description="language id of the video (see [/videos/languages](#operation/getLanguages))")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoConstantStringLanguage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoConstantStringLanguage:
        """Create an instance of VideoConstantStringLanguage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoConstantStringLanguage.parse_obj(obj)

        _obj = VideoConstantStringLanguage.parse_obj({
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
