...
class ApiV1VideosIdRatePutRequest(BaseModel):
    """
    ApiV1VideosIdRatePutRequest
    """
    rating: StrictStr = Field(...)
    __properties = ["rating"]
    ...
    def rating_validate_enum(cls, value):
        ...
        if value not in ('like', 'dislike'):
            raise ValueError("must be one of enum values ('like', 'dislike')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1VideosIdRatePutRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1VideosIdRatePutRequest:
        """Create an instance of ApiV1VideosIdRatePutRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1VideosIdRatePutRequest.parse_obj(obj)

        _obj = ApiV1VideosIdRatePutRequest.parse_obj({
