...
class PluginResponse(BaseModel):
    ...
    data: Optional[conlist(Plugin, max_items=100)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PluginResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PluginResponse:
        """Create an instance of PluginResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PluginResponse.parse_obj(obj)

        _obj = PluginResponse.parse_obj({
            "total": obj.get("total"),
