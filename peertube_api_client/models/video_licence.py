...
class VideoLicence(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoLicence:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoLicence:
        """Create an instance of VideoLicence from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoLicence.parse_obj(obj)

        _obj = VideoLicence.parse_obj({
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
