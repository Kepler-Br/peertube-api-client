...
class ApiV1UsersMeAvatarPickPost200Response(BaseModel):
    """
    ApiV1UsersMeAvatarPickPost200Response
    """
    avatars: Optional[conlist(ActorImage)] = None
    __properties = ["avatars"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1UsersMeAvatarPickPost200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1UsersMeAvatarPickPost200Response:
        """Create an instance of ApiV1UsersMeAvatarPickPost200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1UsersMeAvatarPickPost200Response.parse_obj(obj)

        _obj = ApiV1UsersMeAvatarPickPost200Response.parse_obj({
            "avatars": [ActorImage.from_dict(_item) for _item in obj.get("avatars")] if obj.get("avatars") is not None else None
        })
        return _obj
