...
class GetMyAbuses200Response(BaseModel):
    """
    GetMyAbuses200Response
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(Abuse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetMyAbuses200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetMyAbuses200Response:
        """Create an instance of GetMyAbuses200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetMyAbuses200Response.parse_obj(obj)

        _obj = GetMyAbuses200Response.parse_obj({
            "total": obj.get("total"),
            "data": [Abuse.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
