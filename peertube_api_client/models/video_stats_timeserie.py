...
class VideoStatsTimeserie(BaseModel):
    """
    VideoStatsTimeserie
    """
    data: Optional[conlist(VideoStatsTimeserieDataInner)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoStatsTimeserie:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoStatsTimeserie:
        """Create an instance of VideoStatsTimeserie from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoStatsTimeserie.parse_obj(obj)

        _obj = VideoStatsTimeserie.parse_obj({
            "data": [VideoStatsTimeserieDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
