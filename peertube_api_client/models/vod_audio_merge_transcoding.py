...
class VODAudioMergeTranscoding(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VODAudioMergeTranscoding:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VODAudioMergeTranscoding:
        """Create an instance of VODAudioMergeTranscoding from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VODAudioMergeTranscoding.parse_obj(obj)

        _obj = VODAudioMergeTranscoding.parse_obj({
