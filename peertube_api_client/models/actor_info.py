...
class ActorInfo(BaseModel):
    ...
    __properties = ["id", "name", "displayName", "host", "avatars"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActorInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActorInfo:
        """Create an instance of ActorInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActorInfo.parse_obj(obj)

        _obj = ActorInfo.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
