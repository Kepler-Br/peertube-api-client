...
class VideoListResponse(BaseModel):
    ...
    data: Optional[conlist(Video, max_items=100)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoListResponse:
        """Create an instance of VideoListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoListResponse.parse_obj(obj)

        _obj = VideoListResponse.parse_obj({
            "total": obj.get("total"),
