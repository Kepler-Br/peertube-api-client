...
class GetAccountFollowers200Response(BaseModel):
    """
    GetAccountFollowers200Response
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(Follow)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAccountFollowers200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAccountFollowers200Response:
        """Create an instance of GetAccountFollowers200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAccountFollowers200Response.parse_obj(obj)

        _obj = GetAccountFollowers200Response.parse_obj({
            "total": obj.get("total"),
            "data": [Follow.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
