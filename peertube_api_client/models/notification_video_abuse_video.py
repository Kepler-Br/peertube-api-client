...
class NotificationVideoAbuseVideo(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationVideoAbuseVideo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationVideoAbuseVideo:
        """Create an instance of NotificationVideoAbuseVideo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationVideoAbuseVideo.parse_obj(obj)

        _obj = NotificationVideoAbuseVideo.parse_obj({
            "id": obj.get("id"),
