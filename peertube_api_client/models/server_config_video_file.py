...
class ServerConfigVideoFile(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigVideoFile:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigVideoFile:
        """Create an instance of ServerConfigVideoFile from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigVideoFile.parse_obj(obj)

        _obj = ServerConfigVideoFile.parse_obj({
