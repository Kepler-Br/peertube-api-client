...
class ServerConfigUser(BaseModel):
    """
    ServerConfigUser
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigUser:
        """Create an instance of ServerConfigUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigUser.parse_obj(obj)

        _obj = ServerConfigUser.parse_obj({
