...
class VideoPlaylistPrivacyConstant(BaseModel):
    """
    VideoPlaylistPrivacyConstant
    """
    id: Optional[VideoPlaylistPrivacySet] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoPlaylistPrivacyConstant:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoPlaylistPrivacyConstant:
        """Create an instance of VideoPlaylistPrivacyConstant from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoPlaylistPrivacyConstant.parse_obj(obj)

        _obj = VideoPlaylistPrivacyConstant.parse_obj({
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
