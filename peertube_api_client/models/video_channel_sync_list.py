...
class VideoChannelSyncList(BaseModel):
    """
    VideoChannelSyncList
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(VideoChannelSyncListDataInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoChannelSyncList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoChannelSyncList:
        """Create an instance of VideoChannelSyncList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoChannelSyncList.parse_obj(obj)

        _obj = VideoChannelSyncList.parse_obj({
            "total": obj.get("total"),
            "data": [VideoChannelSyncListDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
