...
class VideoUserHistory(BaseModel):
    ...
    VideoUserHistory
    """
    current_time: Optional[StrictInt] = Field(None, alias="currentTime")
    __properties = ["currentTime"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoUserHistory:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoUserHistory:
        """Create an instance of VideoUserHistory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoUserHistory.parse_obj(obj)

        _obj = VideoUserHistory.parse_obj({
