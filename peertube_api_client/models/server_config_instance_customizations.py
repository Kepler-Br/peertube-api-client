...
class ServerConfigInstanceCustomizations(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigInstanceCustomizations:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigInstanceCustomizations:
        """Create an instance of ServerConfigInstanceCustomizations from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigInstanceCustomizations.parse_obj(obj)

        _obj = ServerConfigInstanceCustomizations.parse_obj({
