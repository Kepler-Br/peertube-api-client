...
class ServerConfigEmail(BaseModel):
    """
    ServerConfigEmail
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigEmail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigEmail:
        """Create an instance of ServerConfigEmail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigEmail.parse_obj(obj)

        _obj = ServerConfigEmail.parse_obj({
