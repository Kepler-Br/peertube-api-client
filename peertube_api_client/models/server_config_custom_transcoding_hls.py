...
class ServerConfigCustomTranscodingHls(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigCustomTranscodingHls:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigCustomTranscodingHls:
        """Create an instance of ServerConfigCustomTranscodingHls from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigCustomTranscodingHls.parse_obj(obj)

        _obj = ServerConfigCustomTranscodingHls.parse_obj({
