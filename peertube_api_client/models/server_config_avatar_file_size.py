...
class ServerConfigAvatarFileSize(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigAvatarFileSize:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigAvatarFileSize:
        """Create an instance of ServerConfigAvatarFileSize from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigAvatarFileSize.parse_obj(obj)

        _obj = ServerConfigAvatarFileSize.parse_obj({
            "max": obj.get("max")
        })
        return _obj
