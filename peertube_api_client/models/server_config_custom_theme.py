...
class ServerConfigCustomTheme(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigCustomTheme:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigCustomTheme:
        """Create an instance of ServerConfigCustomTheme from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigCustomTheme.parse_obj(obj)

        _obj = ServerConfigCustomTheme.parse_obj({
