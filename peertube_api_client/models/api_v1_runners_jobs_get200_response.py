...
class ApiV1RunnersJobsGet200Response(BaseModel):
    """
    ApiV1RunnersJobsGet200Response
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(RunnerJobAdmin)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1RunnersJobsGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1RunnersJobsGet200Response:
        """Create an instance of ApiV1RunnersJobsGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1RunnersJobsGet200Response.parse_obj(obj)

        _obj = ApiV1RunnersJobsGet200Response.parse_obj({
            "total": obj.get("total"),
            "data": [RunnerJobAdmin.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
