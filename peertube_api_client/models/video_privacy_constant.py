...
class VideoPrivacyConstant(BaseModel):
    """
    VideoPrivacyConstant
    """
    id: Optional[VideoPrivacySet] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoPrivacyConstant:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoPrivacyConstant:
        """Create an instance of VideoPrivacyConstant from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoPrivacyConstant.parse_obj(obj)

        _obj = VideoPrivacyConstant.parse_obj({
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
