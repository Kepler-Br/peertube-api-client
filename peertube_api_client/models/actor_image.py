...
class ActorImage(BaseModel):
    ...
    __properties = ["path", "width", "createdAt", "updatedAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActorImage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActorImage:
        """Create an instance of ActorImage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActorImage.parse_obj(obj)

        _obj = ActorImage.parse_obj({
            "path": obj.get("path"),
            "width": obj.get("width"),
