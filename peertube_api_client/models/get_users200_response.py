...
class GetUsers200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetUsers200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetUsers200Response:
        """Create an instance of GetUsers200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetUsers200Response.parse_obj(obj)

        _obj = GetUsers200Response.parse_obj({
            "total": obj.get("total"),
