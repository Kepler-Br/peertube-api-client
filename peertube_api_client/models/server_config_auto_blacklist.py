...
class ServerConfigAutoBlacklist(BaseModel):
    """
    ServerConfigAutoBlacklist
    """
    videos: Optional[ServerConfigAutoBlacklistVideos] = None
    __properties = ["videos"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigAutoBlacklist:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigAutoBlacklist:
        """Create an instance of ServerConfigAutoBlacklist from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigAutoBlacklist.parse_obj(obj)

        _obj = ServerConfigAutoBlacklist.parse_obj({
            "videos": ServerConfigAutoBlacklistVideos.from_dict(obj.get("videos")) if obj.get("videos") is not None else None
        })
        return _obj
