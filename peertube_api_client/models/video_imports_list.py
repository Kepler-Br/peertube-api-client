...
class VideoImportsList(BaseModel):
    """
    VideoImportsList
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(VideoImport, max_items=100)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoImportsList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoImportsList:
        """Create an instance of VideoImportsList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoImportsList.parse_obj(obj)

        _obj = VideoImportsList.parse_obj({
            "total": obj.get("total"),
            "data": [VideoImport.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
