...
class VideosForXMLInnerMediaEmbed(BaseModel):
    """
    VideosForXMLInnerMediaEmbed
    """
    url: Optional[StrictStr] = Field(None, description="video embed path, relative to the canonical URL domain (MRSS)")
    __properties = ["url"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideosForXMLInnerMediaEmbed:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideosForXMLInnerMediaEmbed:
        """Create an instance of VideosForXMLInnerMediaEmbed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideosForXMLInnerMediaEmbed.parse_obj(obj)

        _obj = VideosForXMLInnerMediaEmbed.parse_obj({
            "url": obj.get("url")
        })
        return _obj
