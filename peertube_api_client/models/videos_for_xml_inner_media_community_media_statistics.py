...
class VideosForXMLInnerMediaCommunityMediaStatistics(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideosForXMLInnerMediaCommunityMediaStatistics:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideosForXMLInnerMediaCommunityMediaStatistics:
        """Create an instance of VideosForXMLInnerMediaCommunityMediaStatistics from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideosForXMLInnerMediaCommunityMediaStatistics.parse_obj(obj)

        _obj = VideosForXMLInnerMediaCommunityMediaStatistics.parse_obj({
            "views": obj.get("views")
        })
        return _obj
