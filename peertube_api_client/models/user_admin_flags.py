...
class UserAdminFlags(int, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserAdminFlags:
        """Create an instance of UserAdminFlags from a JSON string"""
        return UserAdminFlags(json.loads(json_str))
