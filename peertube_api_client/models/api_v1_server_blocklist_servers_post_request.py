...
class ApiV1ServerBlocklistServersPostRequest(BaseModel):
    """
    ApiV1ServerBlocklistServersPostRequest
    """
    host: StrictStr = Field(..., description="server domain to block")
    __properties = ["host"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ServerBlocklistServersPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ServerBlocklistServersPostRequest:
        """Create an instance of ApiV1ServerBlocklistServersPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ServerBlocklistServersPostRequest.parse_obj(obj)

        _obj = ApiV1ServerBlocklistServersPostRequest.parse_obj({
            "host": obj.get("host")
        })
        return _obj
