...
class GetVideoCaptions200Response(BaseModel):
    """
    GetVideoCaptions200Response
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(VideoCaption)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetVideoCaptions200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetVideoCaptions200Response:
        """Create an instance of GetVideoCaptions200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetVideoCaptions200Response.parse_obj(obj)

        _obj = GetVideoCaptions200Response.parse_obj({
            "total": obj.get("total"),
            "data": [VideoCaption.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
