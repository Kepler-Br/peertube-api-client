...
class AbuseMessage(BaseModel):
    ...
    message: Optional[constr(strict=True, max_length=3000, min_length=2)] = None
    by_moderator: Optional[StrictBool] = Field(None, alias="byModerator")
    created_at: Optional[datetime] = Field(None, alias="createdAt")
    account: Optional[AccountSummary] = None
    __properties = ["id", "message", "byModerator", "createdAt", "account"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AbuseMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AbuseMessage:
        """Create an instance of AbuseMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AbuseMessage.parse_obj(obj)

        _obj = AbuseMessage.parse_obj({
            "id": obj.get("id"),
            "message": obj.get("message"),
            "by_moderator": obj.get("byModerator"),
