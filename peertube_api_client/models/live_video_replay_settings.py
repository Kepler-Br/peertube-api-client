...
class LiveVideoReplaySettings(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LiveVideoReplaySettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LiveVideoReplaySettings:
        """Create an instance of LiveVideoReplaySettings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LiveVideoReplaySettings.parse_obj(obj)

        _obj = LiveVideoReplaySettings.parse_obj({
