...
class ServerConfigVideo(BaseModel):
    """
    ServerConfigVideo
    """
    image: Optional[ServerConfigVideoImage] = None
    file: Optional[ServerConfigVideoFile] = None
    __properties = ["image", "file"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigVideo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigVideo:
        """Create an instance of ServerConfigVideo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigVideo.parse_obj(obj)

        _obj = ServerConfigVideo.parse_obj({
            "image": ServerConfigVideoImage.from_dict(obj.get("image")) if obj.get("image") is not None else None,
            "file": ServerConfigVideoFile.from_dict(obj.get("file")) if obj.get("file") is not None else None
        })
        return _obj
