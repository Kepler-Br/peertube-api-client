...
class NotificationVideo(BaseModel):
    """
    NotificationVideo
    """
    ...
    channel: Optional[ActorInfo] = None
    __properties = ["id", "uuid", "name", "channel"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationVideo:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of uuid
        if self.uuid:
            _dict['uuid'] = self.uuid.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationVideo:
        """Create an instance of NotificationVideo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationVideo.parse_obj(obj)

        _obj = NotificationVideo.parse_obj({
            "id": obj.get("id"),
            "uuid": Uuid.from_dict(obj.get("uuid")) if obj.get("uuid") is not None else None,
            "name": Name.from_dict(obj.get("name")) if obj.get("name") is not None else None,
            "channel": ActorInfo.from_dict(obj.get("channel")) if obj.get("channel") is not None else None
        })
        return _obj
