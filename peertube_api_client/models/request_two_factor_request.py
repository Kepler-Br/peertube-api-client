...
class RequestTwoFactorRequest(BaseModel):
    """
    RequestTwoFactorRequest
    """
    current_password: Optional[StrictStr] = Field(None, alias="currentPassword", description="Password of the currently authenticated user")
    __properties = ["currentPassword"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RequestTwoFactorRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RequestTwoFactorRequest:
        """Create an instance of RequestTwoFactorRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RequestTwoFactorRequest.parse_obj(obj)

        _obj = RequestTwoFactorRequest.parse_obj({
