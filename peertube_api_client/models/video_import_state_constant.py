...
class VideoImportStateConstant(BaseModel):
    """
    VideoImportStateConstant
    """
    id: Optional[StrictInt] = Field(None, description="The video import state (Pending = `1`, Success = `2`, Failed = `3`)")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoImportStateConstant:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoImportStateConstant:
        """Create an instance of VideoImportStateConstant from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoImportStateConstant.parse_obj(obj)

        _obj = VideoImportStateConstant.parse_obj({
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
