...
class AddPluginRequestOneOf1(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddPluginRequestOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddPluginRequestOneOf1:
        """Create an instance of AddPluginRequestOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddPluginRequestOneOf1.parse_obj(obj)

        _obj = AddPluginRequestOneOf1.parse_obj({
            "path": obj.get("path")
        })
        return _obj
