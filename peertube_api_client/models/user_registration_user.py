...
class UserRegistrationUser(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserRegistrationUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserRegistrationUser:
        """Create an instance of UserRegistrationUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserRegistrationUser.parse_obj(obj)

        _obj = UserRegistrationUser.parse_obj({
            "id": obj.get("id")
        })
        return _obj
