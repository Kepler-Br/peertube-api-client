...
class GetJobs200Response(BaseModel):
    """
    GetJobs200Response
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(Job, max_items=100)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetJobs200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetJobs200Response:
        """Create an instance of GetJobs200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetJobs200Response.parse_obj(obj)

        _obj = GetJobs200Response.parse_obj({
            "total": obj.get("total"),
            "data": [Job.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
