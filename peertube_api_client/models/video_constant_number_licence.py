...
class VideoConstantNumberLicence(BaseModel):
    """
    VideoConstantNumberLicence
    """
    id: Optional[StrictInt] = Field(None, description="licence id of the video (see [/videos/licences](#operation/getLicences))")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoConstantNumberLicence:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoConstantNumberLicence:
        """Create an instance of VideoConstantNumberLicence from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoConstantNumberLicence.parse_obj(obj)

        _obj = VideoConstantNumberLicence.parse_obj({
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
