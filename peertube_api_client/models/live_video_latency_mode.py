...
class LiveVideoLatencyMode(int, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LiveVideoLatencyMode:
        """Create an instance of LiveVideoLatencyMode from a JSON string"""
        return LiveVideoLatencyMode(json.loads(json_str))
