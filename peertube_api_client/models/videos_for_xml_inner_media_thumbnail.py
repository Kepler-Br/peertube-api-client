...
class VideosForXMLInnerMediaThumbnail(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideosForXMLInnerMediaThumbnail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideosForXMLInnerMediaThumbnail:
        """Create an instance of VideosForXMLInnerMediaThumbnail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideosForXMLInnerMediaThumbnail.parse_obj(obj)

        _obj = VideosForXMLInnerMediaThumbnail.parse_obj({
            "url": obj.get("url"),
