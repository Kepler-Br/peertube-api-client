...
class UserRegistrationState(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(None, description="The registration state (Pending = `1`, Rejected = `2`, Accepted = `3`)")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserRegistrationState:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserRegistrationState:
        """Create an instance of UserRegistrationState from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserRegistrationState.parse_obj(obj)

        _obj = UserRegistrationState.parse_obj({
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
