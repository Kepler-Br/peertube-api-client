...
class VODWebVideoTranscoding1(BaseModel):
    """
    VODWebVideoTranscoding1
    """
    input: Optional[VODWebVideoTranscoding1Input] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VODWebVideoTranscoding1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VODWebVideoTranscoding1:
        """Create an instance of VODWebVideoTranscoding1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VODWebVideoTranscoding1.parse_obj(obj)

        _obj = VODWebVideoTranscoding1.parse_obj({
            "input": VODWebVideoTranscoding1Input.from_dict(obj.get("input")) if obj.get("input") is not None else None,
