...
class VideoPlaylistTypeConstant(BaseModel):
    """
    VideoPlaylistTypeConstant
    """
    id: Optional[VideoPlaylistTypeSet] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoPlaylistTypeConstant:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoPlaylistTypeConstant:
        """Create an instance of VideoPlaylistTypeConstant from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoPlaylistTypeConstant.parse_obj(obj)

        _obj = VideoPlaylistTypeConstant.parse_obj({
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
