...
class VideoPlaylistTypeSet(int, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoPlaylistTypeSet:
        """Create an instance of VideoPlaylistTypeSet from a JSON string"""
        return VideoPlaylistTypeSet(json.loads(json_str))
