...
class NotificationListResponse(BaseModel):
    ...
    data: Optional[conlist(Notification, max_items=100)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationListResponse:
        """Create an instance of NotificationListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationListResponse.parse_obj(obj)

        _obj = NotificationListResponse.parse_obj({
            "total": obj.get("total"),
