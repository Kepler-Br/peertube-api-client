...
class ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response(BaseModel):
    """
    ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(VideoPlaylist)] = None
    __properties = ["total", "data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response:
        """Create an instance of ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response.parse_obj(obj)

        _obj = ApiV1VideoChannelsChannelHandleVideoPlaylistsGet200Response.parse_obj({
            "total": obj.get("total"),
            "data": [VideoPlaylist.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
