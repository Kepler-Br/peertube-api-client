...
class VideoStreamingPlaylistsHLSRedundanciesInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoStreamingPlaylistsHLSRedundanciesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoStreamingPlaylistsHLSRedundanciesInner:
        """Create an instance of VideoStreamingPlaylistsHLSRedundanciesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoStreamingPlaylistsHLSRedundanciesInner.parse_obj(obj)

        _obj = VideoStreamingPlaylistsHLSRedundanciesInner.parse_obj({
