...
class VideoChannelSync(BaseModel):
    """
    VideoChannelSync
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoChannelSync:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoChannelSync:
        """Create an instance of VideoChannelSync from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoChannelSync.parse_obj(obj)

        _obj = VideoChannelSync.parse_obj({
            "id": obj.get("id"),
