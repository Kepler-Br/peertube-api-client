...
class ApiV1ServerBlocklistAccountsPostRequest(BaseModel):
    """
    ApiV1ServerBlocklistAccountsPostRequest
    """
    account_name: StrictStr = Field(..., alias="accountName", description="account to block, in the form `username@domain`")
    __properties = ["accountName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ServerBlocklistAccountsPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ServerBlocklistAccountsPostRequest:
        """Create an instance of ApiV1ServerBlocklistAccountsPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ServerBlocklistAccountsPostRequest.parse_obj(obj)

        _obj = ApiV1ServerBlocklistAccountsPostRequest.parse_obj({
