...
class FileRedundancyInformation(BaseModel):
    """
    ...
    __properties = ["id", "fileUrl", "strategy", "size", "createdAt", "updatedAt", "expiresOn"]
    ...
    def strategy_validate_enum(cls, value):
        ...
        if value not in ('manual', 'most-views', 'trending', 'recently-added'):
            raise ValueError("must be one of enum values ('manual', 'most-views', 'trending', 'recently-added')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileRedundancyInformation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FileRedundancyInformation:
        """Create an instance of FileRedundancyInformation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileRedundancyInformation.parse_obj(obj)

        _obj = FileRedundancyInformation.parse_obj({
            "id": obj.get("id"),
