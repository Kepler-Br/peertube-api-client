...
class ApiV1RunnersJobsJobUUIDAcceptPost200Response(BaseModel):
    """
    ApiV1RunnersJobsJobUUIDAcceptPost200Response
    """
    job: Optional[ApiV1RunnersJobsJobUUIDAcceptPost200ResponseJob] = None
    __properties = ["job"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1RunnersJobsJobUUIDAcceptPost200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1RunnersJobsJobUUIDAcceptPost200Response:
        """Create an instance of ApiV1RunnersJobsJobUUIDAcceptPost200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1RunnersJobsJobUUIDAcceptPost200Response.parse_obj(obj)

        _obj = ApiV1RunnersJobsJobUUIDAcceptPost200Response.parse_obj({
            "job": ApiV1RunnersJobsJobUUIDAcceptPost200ResponseJob.from_dict(obj.get("job")) if obj.get("job") is not None else None
        })
        return _obj
