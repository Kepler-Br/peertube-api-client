...
class ServerConfigCustomServices(BaseModel):
    """
    ServerConfigCustomServices
    """
    twitter: Optional[ServerConfigCustomServicesTwitter] = None
    __properties = ["twitter"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigCustomServices:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigCustomServices:
        """Create an instance of ServerConfigCustomServices from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigCustomServices.parse_obj(obj)

        _obj = ServerConfigCustomServices.parse_obj({
            "twitter": ServerConfigCustomServicesTwitter.from_dict(obj.get("twitter")) if obj.get("twitter") is not None else None
        })
        return _obj
