...
class ServerConfigAvatar(BaseModel):
    """
    ServerConfigAvatar
    """
    file: Optional[ServerConfigAvatarFile] = None
    extensions: Optional[conlist(StrictStr)] = None
    __properties = ["file", "extensions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigAvatar:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigAvatar:
        """Create an instance of ServerConfigAvatar from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigAvatar.parse_obj(obj)

        _obj = ServerConfigAvatar.parse_obj({
            "file": ServerConfigAvatarFile.from_dict(obj.get("file")) if obj.get("file") is not None else None,
