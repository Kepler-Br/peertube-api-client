...
class AddUserResponseUser(BaseModel):
    """
    AddUserResponseUser
    """
    id: Optional[conint(strict=True, ge=1)] = None
    account: Optional[ApiV1AbusesPost200ResponseAbuse] = None
    __properties = ["id", "account"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddUserResponseUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddUserResponseUser:
        """Create an instance of AddUserResponseUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddUserResponseUser.parse_obj(obj)

        _obj = AddUserResponseUser.parse_obj({
            "id": obj.get("id"),
            "account": ApiV1AbusesPost200ResponseAbuse.from_dict(obj.get("account")) if obj.get("account") is not None else None
        })
        return _obj
