...
class NotificationComment(BaseModel):
    ...
    thread_id: Optional[StrictInt] = Field(None, alias="threadId")
    video: Optional[VideoInfo] = None
    account: Optional[ActorInfo] = None
    __properties = ["id", "threadId", "video", "account"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationComment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationComment:
        """Create an instance of NotificationComment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationComment.parse_obj(obj)

        _obj = NotificationComment.parse_obj({
            "id": obj.get("id"),
