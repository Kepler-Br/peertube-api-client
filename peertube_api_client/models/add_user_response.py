...
class AddUserResponse(BaseModel):
    ...
    AddUserResponse
    """
    user: Optional[AddUserResponseUser] = None
    __properties = ["user"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddUserResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddUserResponse:
        """Create an instance of AddUserResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddUserResponse.parse_obj(obj)

        _obj = AddUserResponse.parse_obj({
            "user": AddUserResponseUser.from_dict(obj.get("user")) if obj.get("user") is not None else None
        })
        return _obj
