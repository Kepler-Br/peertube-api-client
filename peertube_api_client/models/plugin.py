...
class Plugin(BaseModel):
    ...
    type: Optional[StrictInt] = Field(None, description="- `1`: PLUGIN - `2`: THEME ")
    latest_version: Optional[StrictStr] = Field(None, alias="latestVersion")
    version: Optional[StrictStr] = None
    enabled: Optional[StrictBool] = None
    uninstalled: Optional[StrictBool] = None
    peertube_engine: Optional[StrictStr] = Field(None, alias="peertubeEngine")
    description: Optional[StrictStr] = None
    homepage: Optional[StrictStr] = None
    settings: Optional[Dict[str, Any]] = None
    created_at: Optional[datetime] = Field(None, alias="createdAt")
    updated_at: Optional[datetime] = Field(None, alias="updatedAt")
    __properties = ["name", "type", "latestVersion", "version", "enabled", "uninstalled", "peertubeEngine", "description", "homepage", "settings", "createdAt", "updatedAt"]
    ...
    def from_dict(cls, obj: dict) -> Plugin:
        ...
        _obj = Plugin.parse_obj({
            ...
            "uninstalled": obj.get("uninstalled"),
            "peertube_engine": obj.get("peertubeEngine"),
