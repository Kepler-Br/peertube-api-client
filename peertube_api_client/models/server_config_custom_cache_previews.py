...
class ServerConfigCustomCachePreviews(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigCustomCachePreviews:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigCustomCachePreviews:
        """Create an instance of ServerConfigCustomCachePreviews from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigCustomCachePreviews.parse_obj(obj)

        _obj = ServerConfigCustomCachePreviews.parse_obj({
            "size": obj.get("size")
        })
        return _obj
