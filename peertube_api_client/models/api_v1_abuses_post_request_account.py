...
class ApiV1AbusesPostRequestAccount(BaseModel):
    """
    ApiV1AbusesPostRequestAccount
    """
    id: Optional[StrictInt] = Field(None, description="Account id to report")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AbusesPostRequestAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AbusesPostRequestAccount:
        """Create an instance of ApiV1AbusesPostRequestAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AbusesPostRequestAccount.parse_obj(obj)

        _obj = ApiV1AbusesPostRequestAccount.parse_obj({
            "id": obj.get("id")
        })
        return _obj
