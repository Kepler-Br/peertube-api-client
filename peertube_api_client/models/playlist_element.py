...
class PlaylistElement(BaseModel):
    ...
    __properties = ["position", "startTimestamp", "stopTimestamp", "video"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PlaylistElement:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PlaylistElement:
        """Create an instance of PlaylistElement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PlaylistElement.parse_obj(obj)

        _obj = PlaylistElement.parse_obj({
