...
class ApiV1RunnersUnregisterPostRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1RunnersUnregisterPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1RunnersUnregisterPostRequest:
        """Create an instance of ApiV1RunnersUnregisterPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1RunnersUnregisterPostRequest.parse_obj(obj)

        _obj = ApiV1RunnersUnregisterPostRequest.parse_obj({
