...
class ServerConfigCustomServicesTwitter(BaseModel):
    """
    ServerConfigCustomServicesTwitter
    """
    username: Optional[StrictStr] = None
    whitelisted: Optional[StrictBool] = None
    __properties = ["username", "whitelisted"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigCustomServicesTwitter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigCustomServicesTwitter:
        """Create an instance of ServerConfigCustomServicesTwitter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigCustomServicesTwitter.parse_obj(obj)

        _obj = ServerConfigCustomServicesTwitter.parse_obj({
