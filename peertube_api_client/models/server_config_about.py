...
class ServerConfigAbout(BaseModel):
    """
    ServerConfigAbout
    """
    instance: Optional[ServerConfigAboutInstance] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigAbout:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigAbout:
        """Create an instance of ServerConfigAbout from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigAbout.parse_obj(obj)

        _obj = ServerConfigAbout.parse_obj({
            "instance": ServerConfigAboutInstance.from_dict(obj.get("instance")) if obj.get("instance") is not None else None
        })
        return _obj
