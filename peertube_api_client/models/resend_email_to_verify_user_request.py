...
class ResendEmailToVerifyUserRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResendEmailToVerifyUserRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResendEmailToVerifyUserRequest:
        """Create an instance of ResendEmailToVerifyUserRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResendEmailToVerifyUserRequest.parse_obj(obj)

        _obj = ResendEmailToVerifyUserRequest.parse_obj({
            "email": obj.get("email")
        })
        return _obj
