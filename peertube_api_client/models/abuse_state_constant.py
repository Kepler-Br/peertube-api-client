...
class AbuseStateConstant(BaseModel):
    """
    AbuseStateConstant
    """
    id: Optional[AbuseStateSet] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AbuseStateConstant:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AbuseStateConstant:
        """Create an instance of AbuseStateConstant from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AbuseStateConstant.parse_obj(obj)

        _obj = AbuseStateConstant.parse_obj({
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
