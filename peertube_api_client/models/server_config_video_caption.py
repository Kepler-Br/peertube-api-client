...
class ServerConfigVideoCaption(BaseModel):
    """
    ServerConfigVideoCaption
    """
    file: Optional[ServerConfigVideoCaptionFile] = None
    __properties = ["file"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigVideoCaption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigVideoCaption:
        """Create an instance of ServerConfigVideoCaption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigVideoCaption.parse_obj(obj)

        _obj = ServerConfigVideoCaption.parse_obj({
            "file": ServerConfigVideoCaptionFile.from_dict(obj.get("file")) if obj.get("file") is not None else None
        })
        return _obj
