...
class VideoStatsRetention(BaseModel):
    """
    VideoStatsRetention
    """
    data: Optional[conlist(VideoStatsRetentionDataInner)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoStatsRetention:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoStatsRetention:
        """Create an instance of VideoStatsRetention from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoStatsRetention.parse_obj(obj)

        _obj = VideoStatsRetention.parse_obj({
            "data": [VideoStatsRetentionDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
