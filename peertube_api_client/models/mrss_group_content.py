...
class MRSSGroupContent(BaseModel):
    """
    MRSSGroupContent
    """
    url: Optional[StrictStr] = None
    file_size: Optional[StrictInt] = Field(None, alias="fileSize")
    type: Optional[StrictStr] = None
    framerate: Optional[StrictInt] = None
    duration: Optional[StrictInt] = None
    height: Optional[StrictInt] = None
    lang: Optional[StrictStr] = None
    __properties = ["url", "fileSize", "type", "framerate", "duration", "height", "lang"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MRSSGroupContent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MRSSGroupContent:
        """Create an instance of MRSSGroupContent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MRSSGroupContent.parse_obj(obj)

        _obj = MRSSGroupContent.parse_obj({
            "url": obj.get("url"),
