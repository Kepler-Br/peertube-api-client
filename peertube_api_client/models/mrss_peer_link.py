...
class MRSSPeerLink(BaseModel):
    """
    MRSSPeerLink
    """
    href: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties = ["href", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MRSSPeerLink:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MRSSPeerLink:
        """Create an instance of MRSSPeerLink from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MRSSPeerLink.parse_obj(obj)

        _obj = MRSSPeerLink.parse_obj({
            "href": obj.get("href"),
            "type": obj.get("type")
        })
        return _obj
