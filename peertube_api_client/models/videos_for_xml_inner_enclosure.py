...
class VideosForXMLInnerEnclosure(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('application/x-bittorrent'):
            raise ValueError("must be one of enum values ('application/x-bittorrent')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideosForXMLInnerEnclosure:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideosForXMLInnerEnclosure:
        """Create an instance of VideosForXMLInnerEnclosure from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideosForXMLInnerEnclosure.parse_obj(obj)

        _obj = VideosForXMLInnerEnclosure.parse_obj({
            "url": obj.get("url"),
            "type": obj.get("type"),
