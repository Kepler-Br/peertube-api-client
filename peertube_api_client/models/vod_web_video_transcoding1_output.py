...
class VODWebVideoTranscoding1Output(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VODWebVideoTranscoding1Output:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VODWebVideoTranscoding1Output:
        """Create an instance of VODWebVideoTranscoding1Output from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VODWebVideoTranscoding1Output.parse_obj(obj)

        _obj = VODWebVideoTranscoding1Output.parse_obj({
