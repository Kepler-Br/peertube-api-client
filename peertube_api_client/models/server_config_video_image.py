...
class ServerConfigVideoImage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigVideoImage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigVideoImage:
        """Create an instance of ServerConfigVideoImage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigVideoImage.parse_obj(obj)

        _obj = ServerConfigVideoImage.parse_obj({
