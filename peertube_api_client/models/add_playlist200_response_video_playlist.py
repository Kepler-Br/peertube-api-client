...
class AddPlaylist200ResponseVideoPlaylist(BaseModel):
    """
    ...
    __properties = ["id", "uuid", "shortUUID"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddPlaylist200ResponseVideoPlaylist:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddPlaylist200ResponseVideoPlaylist:
        """Create an instance of AddPlaylist200ResponseVideoPlaylist from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddPlaylist200ResponseVideoPlaylist.parse_obj(obj)

        _obj = AddPlaylist200ResponseVideoPlaylist.parse_obj({
            "id": obj.get("id"),
