...
class ServerConfigCustomAdmin(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigCustomAdmin:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigCustomAdmin:
        """Create an instance of ServerConfigCustomAdmin from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigCustomAdmin.parse_obj(obj)

        _obj = ServerConfigCustomAdmin.parse_obj({
            "email": obj.get("email")
        })
        return _obj
