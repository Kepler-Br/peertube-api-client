...
class VideoUploadRequestCommon(BaseModel):
    """
    ...
    __properties = ["name", "channelId", "privacy", "category", "licence", "language", "description", "waitTranscoding", "support", "nsfw", "tags", "commentsEnabled", "downloadEnabled", "originallyPublishedAt", "scheduleUpdate", "thumbnailfile", "previewfile"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoUploadRequestCommon:
        """Create an instance of VideoUploadRequestCommon from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoUploadRequestCommon:
        """Create an instance of VideoUploadRequestCommon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoUploadRequestCommon.parse_obj(obj)

        _obj = VideoUploadRequestCommon.parse_obj({
            "name": obj.get("name"),
