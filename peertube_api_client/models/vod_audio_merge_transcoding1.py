...
class VODAudioMergeTranscoding1(BaseModel):
    """
    VODAudioMergeTranscoding1
    """
    input: Optional[VODAudioMergeTranscoding1Input] = None
    output: Optional[VODWebVideoTranscoding1Output] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VODAudioMergeTranscoding1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VODAudioMergeTranscoding1:
        """Create an instance of VODAudioMergeTranscoding1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VODAudioMergeTranscoding1.parse_obj(obj)

        _obj = VODAudioMergeTranscoding1.parse_obj({
            "input": VODAudioMergeTranscoding1Input.from_dict(obj.get("input")) if obj.get("input") is not None else None,
            "output": VODWebVideoTranscoding1Output.from_dict(obj.get("output")) if obj.get("output") is not None else None
        })
        return _obj
