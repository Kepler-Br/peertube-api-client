...
class VideoConstantNumberCategory(BaseModel):
    """
    VideoConstantNumberCategory
    """
    id: Optional[StrictInt] = Field(None, description="category id of the video (see [/videos/categories](#operation/getCategories))")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoConstantNumberCategory:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoConstantNumberCategory:
        """Create an instance of VideoConstantNumberCategory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoConstantNumberCategory.parse_obj(obj)

        _obj = VideoConstantNumberCategory.parse_obj({
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
