...
class ServerConfigFollowings(BaseModel):
    """
    ServerConfigFollowings
    """
    instance: Optional[ServerConfigFollowingsInstance] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigFollowings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigFollowings:
        """Create an instance of ServerConfigFollowings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigFollowings.parse_obj(obj)

        _obj = ServerConfigFollowings.parse_obj({
            "instance": ServerConfigFollowingsInstance.from_dict(obj.get("instance")) if obj.get("instance") is not None else None
        })
        return _obj
