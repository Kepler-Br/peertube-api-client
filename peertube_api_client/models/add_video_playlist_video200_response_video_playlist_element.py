...
class AddVideoPlaylistVideo200ResponseVideoPlaylistElement(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddVideoPlaylistVideo200ResponseVideoPlaylistElement:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddVideoPlaylistVideo200ResponseVideoPlaylistElement:
        """Create an instance of AddVideoPlaylistVideo200ResponseVideoPlaylistElement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AddVideoPlaylistVideo200ResponseVideoPlaylistElement.parse_obj(obj)

        _obj = AddVideoPlaylistVideo200ResponseVideoPlaylistElement.parse_obj({
            "id": obj.get("id")
        })
        return _obj
