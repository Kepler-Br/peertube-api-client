...
class UninstallPluginRequest(BaseModel):
    ...
    """
    npm_name: StrictStr = Field(..., alias="npmName", description="name of the plugin/theme in its package.json")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UninstallPluginRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UninstallPluginRequest:
        """Create an instance of UninstallPluginRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UninstallPluginRequest.parse_obj(obj)

        _obj = UninstallPluginRequest.parse_obj({
