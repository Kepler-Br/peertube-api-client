...
class VideoStatsOverallCountriesInner(BaseModel):
    """
    VideoStatsOverallCountriesInner
    """
    iso_code: Optional[StrictStr] = Field(None, alias="isoCode")
    viewers: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["isoCode", "viewers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoStatsOverallCountriesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoStatsOverallCountriesInner:
        """Create an instance of VideoStatsOverallCountriesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoStatsOverallCountriesInner.parse_obj(obj)

        _obj = VideoStatsOverallCountriesInner.parse_obj({
