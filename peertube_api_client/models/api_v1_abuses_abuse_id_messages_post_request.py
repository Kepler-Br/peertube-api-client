...
class ApiV1AbusesAbuseIdMessagesPostRequest(BaseModel):
    """
    ApiV1AbusesAbuseIdMessagesPostRequest
    """
    message: constr(strict=True, max_length=3000, min_length=2) = Field(..., description="Message to send")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AbusesAbuseIdMessagesPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AbusesAbuseIdMessagesPostRequest:
        """Create an instance of ApiV1AbusesAbuseIdMessagesPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AbusesAbuseIdMessagesPostRequest.parse_obj(obj)

        _obj = ApiV1AbusesAbuseIdMessagesPostRequest.parse_obj({
