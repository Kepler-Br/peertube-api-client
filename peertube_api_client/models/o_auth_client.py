...
class OAuthClient(BaseModel):
    ...
    OAuthClient
    """
    client_id: Optional[constr(strict=True, max_length=32, min_length=32)] = None
    client_secret: Optional[constr(strict=True, max_length=32, min_length=32)] = None
    __properties = ["client_id", "client_secret"]
    ...
    def from_dict(cls, obj: dict) -> OAuthClient:
        ...
        if not isinstance(obj, dict):
            return OAuthClient.parse_obj(obj)

        _obj = OAuthClient.parse_obj({
