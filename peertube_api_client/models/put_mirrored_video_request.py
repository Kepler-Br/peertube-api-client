...
class PutMirroredVideoRequest(BaseModel):
    """
    PutMirroredVideoRequest
    """
    video_id: conint(strict=True, ge=1) = Field(..., alias="videoId")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PutMirroredVideoRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PutMirroredVideoRequest:
        """Create an instance of PutMirroredVideoRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PutMirroredVideoRequest.parse_obj(obj)

        _obj = PutMirroredVideoRequest.parse_obj({
