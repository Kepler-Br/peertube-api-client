...
class ServerConfigPlugin(BaseModel):
    """
    ServerConfigPlugin
    """
    registered: Optional[conlist(StrictStr)] = None
    __properties = ["registered"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigPlugin:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigPlugin:
        """Create an instance of ServerConfigPlugin from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigPlugin.parse_obj(obj)

        _obj = ServerConfigPlugin.parse_obj({
