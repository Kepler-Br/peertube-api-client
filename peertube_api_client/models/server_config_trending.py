...
class ServerConfigTrending(BaseModel):
    """
    ServerConfigTrending
    """
    videos: Optional[ServerConfigTrendingVideos] = None
    __properties = ["videos"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigTrending:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigTrending:
        """Create an instance of ServerConfigTrending from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigTrending.parse_obj(obj)

        _obj = ServerConfigTrending.parse_obj({
            "videos": ServerConfigTrendingVideos.from_dict(obj.get("videos")) if obj.get("videos") is not None else None
        })
        return _obj
