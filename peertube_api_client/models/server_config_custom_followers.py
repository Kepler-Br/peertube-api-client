...
class ServerConfigCustomFollowers(BaseModel):
    """
    ServerConfigCustomFollowers
    """
    instance: Optional[ServerConfigCustomFollowersInstance] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigCustomFollowers:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigCustomFollowers:
        """Create an instance of ServerConfigCustomFollowers from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigCustomFollowers.parse_obj(obj)

        _obj = ServerConfigCustomFollowers.parse_obj({
            "instance": ServerConfigCustomFollowersInstance.from_dict(obj.get("instance")) if obj.get("instance") is not None else None
        })
        return _obj
