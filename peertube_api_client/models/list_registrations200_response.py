...
class ListRegistrations200Response(BaseModel):
    """
    ListRegistrations200Response
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(UserRegistration)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListRegistrations200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListRegistrations200Response:
        """Create an instance of ListRegistrations200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListRegistrations200Response.parse_obj(obj)

        _obj = ListRegistrations200Response.parse_obj({
            "total": obj.get("total"),
            "data": [UserRegistration.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
