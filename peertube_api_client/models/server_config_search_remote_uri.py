...
class ServerConfigSearchRemoteUri(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigSearchRemoteUri:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigSearchRemoteUri:
        """Create an instance of ServerConfigSearchRemoteUri from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigSearchRemoteUri.parse_obj(obj)

        _obj = ServerConfigSearchRemoteUri.parse_obj({
            "users": obj.get("users"),
