...
class ApiV1UsersMeNotificationsReadPostRequest(BaseModel):
    """
    ApiV1UsersMeNotificationsReadPostRequest
    """
    ids: conlist(StrictInt) = Field(..., description="ids of the notifications to mark as read")
    __properties = ["ids"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1UsersMeNotificationsReadPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1UsersMeNotificationsReadPostRequest:
        """Create an instance of ApiV1UsersMeNotificationsReadPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1UsersMeNotificationsReadPostRequest.parse_obj(obj)

        _obj = ApiV1UsersMeNotificationsReadPostRequest.parse_obj({
            "ids": obj.get("ids")
        })
        return _obj
