...
class CommentThreadResponse(BaseModel):
    ...
    data: Optional[conlist(VideoComment, max_items=100)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentThreadResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentThreadResponse:
        """Create an instance of CommentThreadResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentThreadResponse.parse_obj(obj)

        _obj = CommentThreadResponse.parse_obj({
            "total": obj.get("total"),
            "data": [VideoComment.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
