...
class ApiV1PluginsNpmNameSettingsPutRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1PluginsNpmNameSettingsPutRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1PluginsNpmNameSettingsPutRequest:
        """Create an instance of ApiV1PluginsNpmNameSettingsPutRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1PluginsNpmNameSettingsPutRequest.parse_obj(obj)

        _obj = ApiV1PluginsNpmNameSettingsPutRequest.parse_obj({
