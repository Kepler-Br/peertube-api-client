...
class VideoPlaylistPrivacySet(int, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoPlaylistPrivacySet:
        """Create an instance of VideoPlaylistPrivacySet from a JSON string"""
        return VideoPlaylistPrivacySet(json.loads(json_str))
