...
class ApiV1RunnersGet200Response(BaseModel):
    """
    ApiV1RunnersGet200Response
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(Runner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1RunnersGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1RunnersGet200Response:
        """Create an instance of ApiV1RunnersGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1RunnersGet200Response.parse_obj(obj)

        _obj = ApiV1RunnersGet200Response.parse_obj({
            "total": obj.get("total"),
            "data": [Runner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
