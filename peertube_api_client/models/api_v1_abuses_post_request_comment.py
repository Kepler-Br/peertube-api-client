...
class ApiV1AbusesPostRequestComment(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AbusesPostRequestComment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AbusesPostRequestComment:
        """Create an instance of ApiV1AbusesPostRequestComment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AbusesPostRequestComment.parse_obj(obj)

        _obj = ApiV1AbusesPostRequestComment.parse_obj({
            "id": obj.get("id")
        })
        return _obj
