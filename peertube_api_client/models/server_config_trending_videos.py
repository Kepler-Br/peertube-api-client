...
class ServerConfigTrendingVideos(BaseModel):
    """
    ServerConfigTrendingVideos
    """
    interval_days: Optional[StrictInt] = Field(None, alias="intervalDays")
    __properties = ["intervalDays"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigTrendingVideos:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigTrendingVideos:
        """Create an instance of ServerConfigTrendingVideos from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigTrendingVideos.parse_obj(obj)

        _obj = ServerConfigTrendingVideos.parse_obj({
            "interval_days": obj.get("intervalDays")
        })
        return _obj
