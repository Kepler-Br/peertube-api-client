...
class VideoChannelSyncState(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoChannelSyncState:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoChannelSyncState:
        """Create an instance of VideoChannelSyncState from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoChannelSyncState.parse_obj(obj)

        _obj = VideoChannelSyncState.parse_obj({
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
