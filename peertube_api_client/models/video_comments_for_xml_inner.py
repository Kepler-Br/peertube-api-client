...
class VideoCommentsForXMLInner(BaseModel):
    """
    ...
    contentencoded: Optional[StrictStr] = Field(None, alias="content:encoded")
    dccreator: Optional[StrictStr] = Field(None, alias="dc:creator")
    __properties = ["link", "guid", "pubDate", "content:encoded", "dc:creator"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoCommentsForXMLInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoCommentsForXMLInner:
        """Create an instance of VideoCommentsForXMLInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoCommentsForXMLInner.parse_obj(obj)

        _obj = VideoCommentsForXMLInner.parse_obj({
            "link": obj.get("link"),
            "guid": obj.get("guid"),
