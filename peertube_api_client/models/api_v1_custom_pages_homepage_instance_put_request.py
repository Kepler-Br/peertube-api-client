...
class ApiV1CustomPagesHomepageInstancePutRequest(BaseModel):
    """
    ApiV1CustomPagesHomepageInstancePutRequest
    """
    content: Optional[StrictStr] = Field(None, description="content of the homepage, that will be injected in the client")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1CustomPagesHomepageInstancePutRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1CustomPagesHomepageInstancePutRequest:
        """Create an instance of ApiV1CustomPagesHomepageInstancePutRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1CustomPagesHomepageInstancePutRequest.parse_obj(obj)

        _obj = ApiV1CustomPagesHomepageInstancePutRequest.parse_obj({
