...
class ApiV1AbusesAbuseIdMessagesGet200Response(BaseModel):
    """
    ApiV1AbusesAbuseIdMessagesGet200Response
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(AbuseMessage)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AbusesAbuseIdMessagesGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AbusesAbuseIdMessagesGet200Response:
        """Create an instance of ApiV1AbusesAbuseIdMessagesGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AbusesAbuseIdMessagesGet200Response.parse_obj(obj)

        _obj = ApiV1AbusesAbuseIdMessagesGet200Response.parse_obj({
            "total": obj.get("total"),
            "data": [AbuseMessage.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
