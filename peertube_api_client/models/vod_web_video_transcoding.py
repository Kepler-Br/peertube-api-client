...
class VODWebVideoTranscoding(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VODWebVideoTranscoding:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VODWebVideoTranscoding:
        """Create an instance of VODWebVideoTranscoding from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VODWebVideoTranscoding.parse_obj(obj)

        _obj = VODWebVideoTranscoding.parse_obj({
