...
class VideoPrivacySet(int, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoPrivacySet:
        """Create an instance of VideoPrivacySet from a JSON string"""
        return VideoPrivacySet(json.loads(json_str))
