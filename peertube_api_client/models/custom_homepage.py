...
class CustomHomepage(BaseModel):
    """
    CustomHomepage
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomHomepage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomHomepage:
        """Create an instance of CustomHomepage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomHomepage.parse_obj(obj)

        _obj = CustomHomepage.parse_obj({
