...
class ApiV1AbusesPost200ResponseAbuse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1AbusesPost200ResponseAbuse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1AbusesPost200ResponseAbuse:
        """Create an instance of ApiV1AbusesPost200ResponseAbuse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1AbusesPost200ResponseAbuse.parse_obj(obj)

        _obj = ApiV1AbusesPost200ResponseAbuse.parse_obj({
            "id": obj.get("id")
        })
        return _obj
