...
class User(BaseModel):
    ...
    __properties = ["account", "autoPlayNextVideo", "autoPlayNextVideoPlaylist", "autoPlayVideo", "blocked", "blockedReason", "createdAt", "email", "emailVerified", "id", "pluginAuth", "lastLoginDate", "noInstanceConfigWarningModal", "noAccountSetupWarningModal", "noWelcomeModal", "nsfwPolicy", "role", "theme", "username", "videoChannels", "videoQuota", "videoQuotaDaily", "p2pEnabled"]
