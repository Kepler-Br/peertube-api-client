...
class Runner(BaseModel):
    ...
    last_contact: Optional[datetime] = Field(None, alias="lastContact")
    __properties = ["id", "name", "description", "ip", "updatedAt", "createdAt", "lastContact"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Runner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Runner:
        """Create an instance of Runner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Runner.parse_obj(obj)

        _obj = Runner.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "last_contact": obj.get("lastContact")
        })
        return _obj
