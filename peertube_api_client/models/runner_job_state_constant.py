...
class RunnerJobStateConstant(BaseModel):
    """
    RunnerJobStateConstant
    """
    id: Optional[RunnerJobState] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RunnerJobStateConstant:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RunnerJobStateConstant:
        """Create an instance of RunnerJobStateConstant from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RunnerJobStateConstant.parse_obj(obj)

        _obj = RunnerJobStateConstant.parse_obj({
            "id": obj.get("id"),
            "label": obj.get("label")
        })
        return _obj
