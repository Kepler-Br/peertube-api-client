...
class GetVideoBlocks200Response(BaseModel):
    """
    GetVideoBlocks200Response
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(VideoBlacklist)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetVideoBlocks200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetVideoBlocks200Response:
        """Create an instance of GetVideoBlocks200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetVideoBlocks200Response.parse_obj(obj)

        _obj = GetVideoBlocks200Response.parse_obj({
            "total": obj.get("total"),
            "data": [VideoBlacklist.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
