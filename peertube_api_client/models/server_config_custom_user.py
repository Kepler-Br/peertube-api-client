...
class ServerConfigCustomUser(BaseModel):
    """
    Settings that apply to new users, if registration is enabled
    """
    video_quota: Optional[StrictInt] = Field(None, alias="videoQuota")
    video_quota_daily: Optional[StrictInt] = Field(None, alias="videoQuotaDaily")
    __properties = ["videoQuota", "videoQuotaDaily"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigCustomUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigCustomUser:
        """Create an instance of ServerConfigCustomUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigCustomUser.parse_obj(obj)

        _obj = ServerConfigCustomUser.parse_obj({
