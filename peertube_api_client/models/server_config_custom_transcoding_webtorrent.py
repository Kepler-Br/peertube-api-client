...
class ServerConfigCustomTranscodingWebtorrent(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigCustomTranscodingWebtorrent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigCustomTranscodingWebtorrent:
        """Create an instance of ServerConfigCustomTranscodingWebtorrent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigCustomTranscodingWebtorrent.parse_obj(obj)

        _obj = ServerConfigCustomTranscodingWebtorrent.parse_obj({
