...
class ServerConfigAboutInstance(BaseModel):
    """
    ...
    __properties = ["name", "shortDescription", "description", "terms"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigAboutInstance:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigAboutInstance:
        """Create an instance of ServerConfigAboutInstance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigAboutInstance.parse_obj(obj)

        _obj = ServerConfigAboutInstance.parse_obj({
            "name": obj.get("name"),
