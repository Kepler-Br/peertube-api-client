...
class ServerConfigVideoCaptionFile(BaseModel):
    """
    ServerConfigVideoCaptionFile
    """
    size: Optional[ServerConfigAvatarFileSize] = None
    extensions: Optional[conlist(StrictStr)] = None
    __properties = ["size", "extensions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigVideoCaptionFile:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigVideoCaptionFile:
        """Create an instance of ServerConfigVideoCaptionFile from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigVideoCaptionFile.parse_obj(obj)

        _obj = ServerConfigVideoCaptionFile.parse_obj({
            "size": ServerConfigAvatarFileSize.from_dict(obj.get("size")) if obj.get("size") is not None else None,
