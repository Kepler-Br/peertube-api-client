...
class VideoRating(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoRating:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoRating:
        """Create an instance of VideoRating from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoRating.parse_obj(obj)

        _obj = VideoRating.parse_obj({
