...
class NotificationActorFollow(BaseModel):
    """
    NotificationActorFollow
    """
    id: Optional[conint(strict=True, ge=1)] = None
    follower: Optional[ActorInfo] = None
    state: Optional[StrictStr] = None
    following: Optional[NotificationActorFollowFollowing] = None
    __properties = ["id", "follower", "state", "following"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationActorFollow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationActorFollow:
        """Create an instance of NotificationActorFollow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationActorFollow.parse_obj(obj)

        _obj = NotificationActorFollow.parse_obj({
            "id": obj.get("id"),
            "follower": ActorInfo.from_dict(obj.get("follower")) if obj.get("follower") is not None else None,
            "state": obj.get("state"),
            "following": NotificationActorFollowFollowing.from_dict(obj.get("following")) if obj.get("following") is not None else None
        })
        return _obj
