...
class VideoChannelSummary(BaseModel):
    """
    VideoChannelSummary
    """
    ...
    __properties = ["id", "name", "displayName", "url", "host", "avatars"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoChannelSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoChannelSummary:
        """Create an instance of VideoChannelSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoChannelSummary.parse_obj(obj)

        _obj = VideoChannelSummary.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
