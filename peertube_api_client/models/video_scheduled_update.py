...
class VideoScheduledUpdate(BaseModel):
    """
    VideoScheduledUpdate
    """
    privacy: Optional[VideoPrivacySet] = None
    update_at: date = Field(..., alias="updateAt", description="When to update the video")
    __properties = ["privacy", "updateAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoScheduledUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoScheduledUpdate:
        """Create an instance of VideoScheduledUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoScheduledUpdate.parse_obj(obj)

        _obj = VideoScheduledUpdate.parse_obj({
