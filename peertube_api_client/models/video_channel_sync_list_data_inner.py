...
class VideoChannelSyncListDataInner(BaseModel):
    """
    VideoChannelSyncListDataInner
    """
    id: Optional[conint(strict=True, ge=1)] = None
    state: Optional[VideoChannelSyncState] = None
    external_channel_url: Optional[StrictStr] = Field(None, alias="externalChannelUrl")
    created_at: Optional[datetime] = Field(None, alias="createdAt")
    last_sync_at: Optional[datetime] = Field(None, alias="lastSyncAt")
    channel: Optional[VideoChannel] = None
    __properties = ["id", "state", "externalChannelUrl", "createdAt", "lastSyncAt", "channel"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoChannelSyncListDataInner:
    ...
    def to_dict(self):
        ...
        if self.last_sync_at is None and "last_sync_at" in self.__fields_set__:
            _dict['lastSyncAt'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> VideoChannelSyncListDataInner:
        """Create an instance of VideoChannelSyncListDataInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoChannelSyncListDataInner.parse_obj(obj)

        _obj = VideoChannelSyncListDataInner.parse_obj({
            "id": obj.get("id"),
            "state": VideoChannelSyncState.from_dict(obj.get("state")) if obj.get("state") is not None else None,
            "external_channel_url": obj.get("externalChannelUrl"),
            "created_at": obj.get("createdAt"),
            "last_sync_at": obj.get("lastSyncAt"),
