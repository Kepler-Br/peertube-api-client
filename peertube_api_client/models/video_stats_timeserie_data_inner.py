...
class VideoStatsTimeserieDataInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoStatsTimeserieDataInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoStatsTimeserieDataInner:
        """Create an instance of VideoStatsTimeserieDataInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoStatsTimeserieDataInner.parse_obj(obj)

        _obj = VideoStatsTimeserieDataInner.parse_obj({
