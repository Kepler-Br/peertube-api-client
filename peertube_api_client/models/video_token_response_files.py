...
class VideoTokenResponseFiles(BaseModel):
    """
    VideoTokenResponseFiles
    """
    token: Optional[StrictStr] = None
    expires: Optional[datetime] = None
    __properties = ["token", "expires"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoTokenResponseFiles:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoTokenResponseFiles:
        """Create an instance of VideoTokenResponseFiles from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoTokenResponseFiles.parse_obj(obj)

        _obj = VideoTokenResponseFiles.parse_obj({
            "token": obj.get("token"),
