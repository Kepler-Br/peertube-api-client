...
class VideoChannelList(BaseModel):
    """
    VideoChannelList
    """
    total: Optional[StrictInt] = None
    data: Optional[conlist(VideoChannelListDataInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoChannelList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoChannelList:
        """Create an instance of VideoChannelList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoChannelList.parse_obj(obj)

        _obj = VideoChannelList.parse_obj({
            "total": obj.get("total"),
            "data": [VideoChannelListDataInner.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
