...
class RunnerJobRunner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RunnerJobRunner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RunnerJobRunner:
        """Create an instance of RunnerJobRunner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RunnerJobRunner.parse_obj(obj)

        _obj = RunnerJobRunner.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
