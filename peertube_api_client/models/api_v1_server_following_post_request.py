...
class ApiV1ServerFollowingPostRequest(BaseModel):
    """
    ApiV1ServerFollowingPostRequest
    """
    hosts: Optional[conlist(StrictStr, unique_items=True)] = None
    handles: Optional[conlist(StrictStr, unique_items=True)] = None
    __properties = ["hosts", "handles"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1ServerFollowingPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1ServerFollowingPostRequest:
        """Create an instance of ApiV1ServerFollowingPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1ServerFollowingPostRequest.parse_obj(obj)

        _obj = ApiV1ServerFollowingPostRequest.parse_obj({
            "hosts": obj.get("hosts"),
