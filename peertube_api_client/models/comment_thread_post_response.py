...
class CommentThreadPostResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentThreadPostResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentThreadPostResponse:
        """Create an instance of CommentThreadPostResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentThreadPostResponse.parse_obj(obj)

        _obj = CommentThreadPostResponse.parse_obj({
