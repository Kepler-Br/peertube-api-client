...
class ServerConfigAvatarFile(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServerConfigAvatarFile:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServerConfigAvatarFile:
        """Create an instance of ServerConfigAvatarFile from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServerConfigAvatarFile.parse_obj(obj)

        _obj = ServerConfigAvatarFile.parse_obj({
