...
class VODHLSTranscoding1(BaseModel):
    """
    VODHLSTranscoding1
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VODHLSTranscoding1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VODHLSTranscoding1:
        """Create an instance of VODHLSTranscoding1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VODHLSTranscoding1.parse_obj(obj)

        _obj = VODHLSTranscoding1.parse_obj({
