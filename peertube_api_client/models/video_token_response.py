...
class VideoTokenResponse(BaseModel):
    ...
    VideoTokenResponse
    """
    files: Optional[VideoTokenResponseFiles] = None
    __properties = ["files"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoTokenResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoTokenResponse:
        """Create an instance of VideoTokenResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoTokenResponse.parse_obj(obj)

        _obj = VideoTokenResponse.parse_obj({
            "files": VideoTokenResponseFiles.from_dict(obj.get("files")) if obj.get("files") is not None else None
        })
        return _obj
