...
class VideoUploadResponse(BaseModel):
    ...
    VideoUploadResponse
    """
    video: Optional[VideoUploadResponseVideo] = None
    __properties = ["video"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoUploadResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoUploadResponse:
        """Create an instance of VideoUploadResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoUploadResponse.parse_obj(obj)

        _obj = VideoUploadResponse.parse_obj({
            "video": VideoUploadResponseVideo.from_dict(obj.get("video")) if obj.get("video") is not None else None
        })
        return _obj
