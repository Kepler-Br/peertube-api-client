...
class ResendEmailToVerifyRegistrationRequest(BaseModel):
    """
    ResendEmailToVerifyRegistrationRequest
    """
    email: StrictStr = Field(..., description="Registration email")
    __properties = ["email"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResendEmailToVerifyRegistrationRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResendEmailToVerifyRegistrationRequest:
        """Create an instance of ResendEmailToVerifyRegistrationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResendEmailToVerifyRegistrationRequest.parse_obj(obj)

        _obj = ResendEmailToVerifyRegistrationRequest.parse_obj({
            "email": obj.get("email")
        })
        return _obj
