...
class ApiV1VideosIdCommentThreadsPostRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1VideosIdCommentThreadsPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1VideosIdCommentThreadsPostRequest:
        """Create an instance of ApiV1VideosIdCommentThreadsPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1VideosIdCommentThreadsPostRequest.parse_obj(obj)

        _obj = ApiV1VideosIdCommentThreadsPostRequest.parse_obj({
            "text": Text.from_dict(obj.get("text")) if obj.get("text") is not None else None
        })
        return _obj
