...
class AbuseStateSet(int, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AbuseStateSet:
        """Create an instance of AbuseStateSet from a JSON string"""
        return AbuseStateSet(json.loads(json_str))
