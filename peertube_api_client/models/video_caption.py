...
class VideoCaption(BaseModel):
    ...
    VideoCaption
    """
    language: Optional[VideoConstantStringLanguage] = None
    caption_path: Optional[StrictStr] = Field(None, alias="captionPath")
    __properties = ["language", "captionPath"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VideoCaption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VideoCaption:
        """Create an instance of VideoCaption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VideoCaption.parse_obj(obj)

        _obj = VideoCaption.parse_obj({
            "language": VideoConstantStringLanguage.from_dict(obj.get("language")) if obj.get("language") is not None else None,
            "caption_path": obj.get("captionPath")
        })
        return _obj
