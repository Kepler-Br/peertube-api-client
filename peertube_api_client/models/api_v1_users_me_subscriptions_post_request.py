...
class ApiV1UsersMeSubscriptionsPostRequest(BaseModel):
    """
    ApiV1UsersMeSubscriptionsPostRequest
    """
    uri: StrictStr = Field(..., description="uri of the video channels to subscribe to")
    __properties = ["uri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiV1UsersMeSubscriptionsPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiV1UsersMeSubscriptionsPostRequest:
        """Create an instance of ApiV1UsersMeSubscriptionsPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiV1UsersMeSubscriptionsPostRequest.parse_obj(obj)

        _obj = ApiV1UsersMeSubscriptionsPostRequest.parse_obj({
            "uri": obj.get("uri")
        })
        return _obj
