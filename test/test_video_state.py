...
from peertube_api_client.models.video_state import VideoState  # noqa: E501
...
class TestVideoState(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `VideoState`
        """
        model = peertube_api_client.models.video_state.VideoState()  # noqa: E501
        if include_optional :
            return VideoState(
                id = 1, 
                label = ''
