...
from peertube_api_client.models.server_config_import import ServerConfigImport  # noqa: E501
...
class TestServerConfigImport(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ServerConfigImport`
        """
        model = peertube_api_client.models.server_config_import.ServerConfigImport()  # noqa: E501
        if include_optional :
