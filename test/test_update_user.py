...
from peertube_api_client.models.update_user import UpdateUser  # noqa: E501
...
class TestUpdateUser(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = peertube_api_client.models.update_user.UpdateUser()  # noqa: E501
        if include_optional :
            return UpdateUser(
                email = None, 
                email_verified = True, 
                video_quota = 56, 
                video_quota_daily = 56, 
                plugin_auth = 'peertube-plugin-auth-saml2', 
                role = 2, 
                admin_flags = 1, 
                password = '012345'
            )
