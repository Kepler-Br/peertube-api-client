...
from peertube_api_client.api.stats_api import StatsApi  # noqa: E501
...
class TestStatsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = peertube_api_client.api.stats_api.StatsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_api_v1_metrics_playback_post(self):
        """Test case for api_v1_metrics_playback_post
