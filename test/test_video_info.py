...
from peertube_api_client.models.video_info import VideoInfo  # noqa: E501
from peertube_api_client.rest import ApiException

class TestVideoInfo(unittest.TestCase):
    """VideoInfo unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `VideoInfo`
        """
        model = peertube_api_client.models.video_info.VideoInfo()  # noqa: E501
        if include_optional :
            return VideoInfo(
                id = 42, 
                uuid = None, 
