...
from peertube_api_client.models.get_jobs200_response import GetJobs200Response  # noqa: E501
...
class TestGetJobs200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = peertube_api_client.models.get_jobs200_response.GetJobs200Response()  # noqa: E501
        if include_optional :
            return GetJobs200Response(
                total = 1, 
                data = [
                    peertube_api_client.models.job.Job(
                        id = 42, 
                        state = 'active', 
