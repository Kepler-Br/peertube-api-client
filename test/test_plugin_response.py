...
from peertube_api_client.models.plugin_response import PluginResponse  # noqa: E501
...
class TestPluginResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = peertube_api_client.models.plugin_response.PluginResponse()  # noqa: E501
        if include_optional :
            return PluginResponse(
                total = 1, 
                data = [
                    peertube_api_client.models.plugin.Plugin(
