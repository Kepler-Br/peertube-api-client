...
from peertube_api_client.models.video_source import VideoSource  # noqa: E501
...
class TestVideoSource(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `VideoSource`
        """
        model = peertube_api_client.models.video_source.VideoSource()  # noqa: E501
        if include_optional :
            return VideoSource(
                filename = ''
            )
